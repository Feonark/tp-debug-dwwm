 ...
 */
final class Version20250605091924 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE "like" (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, todo_id INTEGER NOT NULL, creator_id INTEGER NOT NULL, CONSTRAINT FK_AC6340B3EA1EBC33 FOREIGN KEY (todo_id) REFERENCES todo (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_AC6340B361220EA6 FOREIGN KEY (creator_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_AC6340B3EA1EBC33 ON "like" (todo_id)
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_AC6340B361220EA6 ON "like" (creator_id)
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE network (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, created_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_608487BCA76ED395 ON network (user_id)
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE task (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, todo_id INTEGER NOT NULL, created_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
            , updated_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_527EDB25EA1EBC33 ON task (todo_id)
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE todo (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, creator_id INTEGER NOT NULL, updated_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_5A0EB6A061220EA6 ON todo (creator_id)
        SQL);
        $this->addSql(<<<'SQL'
